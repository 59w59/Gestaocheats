...
<head>
    ...
    <title>Comprar Planos - <?php echo SITE_NAME; ?></title>
    ...
    <style>
        ...
        .plan-card {
            position: relative;
            background: linear-gradient(145deg, rgba(0, 44, 58, 0.9), rgba(0, 20, 30, 0.95));
        ...
        .plan-card:hover {
            ...
            box-shadow: 0 10px 25px rgba(0, 0, 0, 0.3), 0 0 15px rgba(0, 207, 155, 0.2);
            border-color: var(--primary-alpha-50);
        }

        .plan-card.popular {
            border: 2px solid var(--primary);
            box-shadow: 0 0 20px rgba(0, 207, 155, 0.3);
        }
        ...
        /* Melhorias visuais para os botões de filtro */
        .btn-outline-primary {
            border-color: var(--primary-alpha-50);
            color: var(--primary-light);
        }
        ...
        .btn-outline-primary.active {
            ...
            color: var(--dark);
            box-shadow: 0 0 15px rgba(0, 207, 155, 0.5);
        }
    </style>
</head>
<body class="dashboard-page">
    ...
    <header class="dashboard-header">
        <div class="container">
            ...
            <ul>
                    <li><a href="purchases.php" class="active">Comprar Planos</a></li>
    ...
    <main class="dashboard-main">
        <div class="container">
            <div class="page-header">
                ...
                <p>Escolha o plano de assinatura que melhor atende às suas necessidades</p>
            </div>

            <?php if ($has_active_subscription): ?>
            <!-- Active Subscription -->
            <section class="active-subscription">
                <h2 class="section-title">Sua Assinatura Atual</h2>
